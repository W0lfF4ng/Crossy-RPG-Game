############################################################
# Programmer: W0lf_F4ng
# Title: Crossy RPG Game
# Version: 1.0
# Course: Learn Python Programming by Making a Game - Zenva
############################################################
...
class Game:
	...
	def run_game_loop(self, level_speed):
		...
		# Defined enemy characters and speed increased as we advance in difficulty
		enemy_0 = NonPlayerCharacter('img/enemy.png', 20, 600, 50, 50)
		enemy_0.SPEED *= level_speed
		enemy_1 = NonPlayerCharacter('img/enemy.png', self.width - 40, 400, 50, 50)
		enemy_1.SPEED *= level_speed
		enemy_2 = NonPlayerCharacter('img/enemy.png', 20, 300, 50, 50)
		...
		while not is_game_over:
			...
			pygame.display.update()
			# Tick the clock to update everythings within the game
